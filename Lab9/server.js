...
// The below code is the boilerplate code that is required to set-up url-encoding, sessions, cookies and flash messages for you webapp.
...
// Since we want to make our App modular we will create different modules - index and store. 
